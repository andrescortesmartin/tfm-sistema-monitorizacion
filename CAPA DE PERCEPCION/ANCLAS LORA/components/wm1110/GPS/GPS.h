...
/**
 * @brief Bandera que indica si el GPS tiene un fix válido
 * @details true si el GPS tiene posición válida, false en caso contrario
 */
extern bool fix_valido;
...
/**
 * @brief Decodifica una línea NMEA del GPS
 * @param line Cadena de caracteres con la línea NMEA a decodificar
 * @details Procesa una sentencia NMEA y actualiza los datos de posición
 *          (latitud, longitud, altitud, etc.)
 */
void gps_decodificar(char *line);
